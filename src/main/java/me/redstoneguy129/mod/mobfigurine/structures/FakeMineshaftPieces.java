...
import me.redstoneguy129.mod.mobfigurine.Figurine;
import me.redstoneguy129.mod.mobfigurine.FigurineRarity;
import me.redstoneguy129.mod.mobfigurine.MFBlocks;
...
public class FakeMineshaftPieces {
    private static FakeMineshaftPieces.Piece createRandomShaftPiece(List<StructurePiece> p_189940_0_, Random p_189940_1_, int p_189940_2_, int p_189940_3_, int p_189940_4_, @Nullable Direction p_189940_5_, int p_189940_6_, FakeMineshaftStructure.Type p_189940_7_) {
        int i = p_189940_1_.nextInt(100);
        if (i >= 80) {
            MutableBoundingBox mutableboundingbox = FakeMineshaftPieces.Cross.findCrossing(p_189940_0_, p_189940_1_, p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);
            if (mutableboundingbox != null) {
                return new FakeMineshaftPieces.Cross(p_189940_6_, mutableboundingbox, p_189940_5_, p_189940_7_);
            }
        } else if (i >= 70) {
            MutableBoundingBox mutableboundingbox1 = FakeMineshaftPieces.Stairs.findStairs(p_189940_0_, p_189940_1_, p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);
            if (mutableboundingbox1 != null) {
                return new FakeMineshaftPieces.Stairs(p_189940_6_, mutableboundingbox1, p_189940_5_, p_189940_7_);
            }
        } else {
            MutableBoundingBox mutableboundingbox2 = FakeMineshaftPieces.Corridor.findCorridorSize(p_189940_0_, p_189940_1_, p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);
            if (mutableboundingbox2 != null) {
                return new FakeMineshaftPieces.Corridor(p_189940_6_, p_189940_1_, mutableboundingbox2, p_189940_5_, p_189940_7_);
            }
        }
    ...
    private static FakeMineshaftPieces.Piece generateAndAddPiece(StructurePiece p_189938_0_, List<StructurePiece> p_189938_1_, Random p_189938_2_, int p_189938_3_, int p_189938_4_, int p_189938_5_, Direction p_189938_6_, int p_189938_7_) {
        if (p_189938_7_ > 8) {
            return null;
        } else if (Math.abs(p_189938_3_ - p_189938_0_.getBoundingBox().minX) <= 80 && Math.abs(p_189938_5_ - p_189938_0_.getBoundingBox().minZ) <= 80) {
            FakeMineshaftStructure.Type mineshaftstructure$type = ((FakeMineshaftPieces.Piece)p_189938_0_).mineShaftType;
            FakeMineshaftPieces.Piece mineshaftpieces$piece = createRandomShaftPiece(p_189938_1_, p_189938_2_, p_189938_3_, p_189938_4_, p_189938_5_, p_189938_6_, p_189938_7_ + 1, mineshaftstructure$type);
    ...
    public static class Corridor extends FakeMineshaftPieces.Piece {
        ...
        public Corridor(TemplateManager p_i50456_1_, CompoundNBT p_i50456_2_) {
            super(MFStructures.MSCORRIDOR, p_i50456_2_);
        ...
        public Corridor(int p_i47140_1_, Random p_i47140_2_, MutableBoundingBox p_i47140_3_, Direction p_i47140_4_, FakeMineshaftStructure.Type p_i47140_5_) {
            super(MFStructures.MSCORRIDOR, p_i47140_1_, p_i47140_5_);
        ...
        public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand) {
            ...
            if (direction != null) {
                switch(direction) {
                    ...
                    default:
                        if (j <= 1) {
                            FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ - 1, direction, i);
                        } else if (j == 2) {
                            FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, Direction.WEST, i);
                        } else {
                            FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, Direction.EAST, i);
                        }
                        break;
                    case SOUTH:
                        if (j <= 1) {
                            FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ + 1, direction, i);
                        } else if (j == 2) {
                            FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ - 3, Direction.WEST, i);
                        } else {
                            FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ - 3, Direction.EAST, i);
                        }
                        break;
                    case WEST:
                        if (j <= 1) {
                            FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, direction, i);
                        } else if (j == 2) {
                            FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ - 1, Direction.NORTH, i);
                        } else {
                            FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ + 1, Direction.SOUTH, i);
                        }
                        break;
                    case EAST:
                        if (j <= 1) {
                            FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, direction, i);
                        } else if (j == 2) {
                            FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX - 3, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ - 1, Direction.NORTH, i);
                        } else {
                            FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX - 3, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ + 1, Direction.SOUTH, i);
                        }
                }
            }
            ...
            if (i < 8) {
                if (direction != Direction.NORTH && direction != Direction.SOUTH) {
                    for(int i1 = this.boundingBox.minX + 3; i1 + 3 <= this.boundingBox.maxX; i1 += 5) {
                        ...
                        if (j1 == 0) {
                            FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, i1, this.boundingBox.minY, this.boundingBox.minZ - 1, Direction.NORTH, i + 1);
                        } else if (j1 == 1) {
                            FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, i1, this.boundingBox.minY, this.boundingBox.maxZ + 1, Direction.SOUTH, i + 1);
                        }
                    }
                } else {
                    for(int k = this.boundingBox.minZ + 3; k + 3 <= this.boundingBox.maxZ; k += 5) {
                        ...
                        if (l == 0) {
                            FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, k, Direction.WEST, i + 1);
                        } else if (l == 1) {
                            FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, k, Direction.EAST, i + 1);
                        }
                    }
                }
            }
        ...
        protected boolean generateFigurine(IWorld world, MutableBoundingBox structurebb, Random randomIn, int x, int y, int z) {
            BlockPos blockpos = new BlockPos(this.getXWithOffset(x, z), this.getYWithOffset(y), this.getZWithOffset(x, z));
            if (structurebb.isVecInside(blockpos) && world.getBlockState(blockpos).isAir(world, blockpos) && !world.getBlockState(blockpos.down()).isAir(world, blockpos.down())) {
                BlockState blockState = chooseBlock(randomIn).getDefaultState().with(Figurine.FACING, Direction.byHorizontalIndex(randomIn.nextInt(4)));
        ...
        private Figurine chooseBlock(Random random) {
            List<Figurine> figurineList = figurineList(MFBlocks.REGISTER.getEntries());
            FigurineRarity rarity = FigurineRarity.CommonOrRare(random);
            for(int i = 0; i < figurineList.size(); i++) {
                if(figurineList.get(i).getRarity() != rarity) figurineList.remove(i);
            }
            if(figurineList.isEmpty()) {
                figurineList.add(figurineList(MFBlocks.REGISTER.getEntries()).get(0));
            }
            return figurineList.get(random.nextInt(figurineList.size()));
        }

        private List<Figurine> figurineList(Collection<RegistryObject<Block>> coll) {
            List<Figurine> list = new ArrayList<>();
            coll.forEach(blockRegistryObject -> {
                Block block = blockRegistryObject.get();
                if(block instanceof Figurine)
                    list.add((Figurine) block);
            });
            return list;
        }
        ...
        public boolean create(IWorld worldIn, ChunkGenerator<?> chunkGeneratorIn, Random randomIn, MutableBoundingBox mutableBoundingBoxIn, ChunkPos chunkPosIn) {
            if (this.isLiquidInStructureBoundingBox(worldIn, mutableBoundingBoxIn)) {
                ...
                for(int j1 = 0; j1 < this.sectionCount; ++j1) {
                    ...
                    if (randomIn.nextInt(100) == 1) {
                        this.generateFigurine(worldIn, mutableBoundingBoxIn, randomIn, 0, 0, k1-1);
                    }
        ...
        private void placeSupport(IWorld p_189921_1_, MutableBoundingBox p_189921_2_, int p_189921_3_, int p_189921_4_, int p_189921_5_, int p_189921_6_, int p_189921_7_, Random p_189921_8_) {
            if (this.isSupportingBox(p_189921_1_, p_189921_2_, p_189921_3_, p_189921_7_, p_189921_6_, p_189921_5_)) {
                ...
                this.fillWithBlocks(p_189921_1_, p_189921_2_, p_189921_3_, p_189921_4_, p_189921_5_, p_189921_3_, p_189921_6_ - 1, p_189921_5_, blockstate1.with(FenceBlock.WEST, Boolean.TRUE), CAVE_AIR, false);
                this.fillWithBlocks(p_189921_1_, p_189921_2_, p_189921_7_, p_189921_4_, p_189921_5_, p_189921_7_, p_189921_6_ - 1, p_189921_5_, blockstate1.with(FenceBlock.EAST, Boolean.TRUE), CAVE_AIR, false);
    ...
    public static class Cross extends FakeMineshaftPieces.Piece {
        ...
        public Cross(TemplateManager p_i50454_1_, CompoundNBT p_i50454_2_) {
            super(MFStructures.MSCROSSING, p_i50454_2_);
        ...
        public Cross(int p_i50455_1_, MutableBoundingBox p_i50455_2_, @Nullable Direction p_i50455_3_, FakeMineshaftStructure.Type p_i50455_4_) {
            super(MFStructures.MSCROSSING, p_i50455_1_, p_i50455_4_);
        ...
        public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand) {
            ...
            switch(this.corridorDirection) {
                case NORTH:
                default:
                    FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.minZ - 1, Direction.NORTH, i);
                    FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + 1, Direction.WEST, i);
                    FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ + 1, Direction.EAST, i);
                    break;
                case SOUTH:
                    FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.maxZ + 1, Direction.SOUTH, i);
                    FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + 1, Direction.WEST, i);
                    FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ + 1, Direction.EAST, i);
                    break;
                case WEST:
            ...
            if (this.isMultipleFloors) {
                if (rand.nextBoolean()) {
                    FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ - 1, Direction.NORTH, i);
                }

                if (rand.nextBoolean()) {
                    FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ + 1, Direction.WEST, i);
                }

                if (rand.nextBoolean()) {
                    FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ + 1, Direction.EAST, i);
                }

                if (rand.nextBoolean()) {
                    FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.maxZ + 1, Direction.SOUTH, i);
                }
            }
    ...
    abstract static class Piece extends StructurePiece {
        protected FakeMineshaftStructure.Type mineShaftType;

        public Piece(IStructurePieceType structurePieceTypeIn, int componentTypeIn, FakeMineshaftStructure.Type typeIn) {
        ...
        public Piece(IStructurePieceType structurePieceTypeIn, CompoundNBT nbt) {
            ...
            this.mineShaftType = FakeMineshaftStructure.Type.byId(nbt.getInt("MST"));
        }
    ...
    public static class Room extends FakeMineshaftPieces.Piece {
        private final List<MutableBoundingBox> connectedRooms = Lists.newLinkedList();

        public Room(int p_i47137_1_, Random p_i47137_2_, int p_i47137_3_, int p_i47137_4_, FakeMineshaftStructure.Type typeIn) {
            super(MFStructures.MSROOM, p_i47137_1_, typeIn);
            this.mineShaftType = typeIn;
        ...
        public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand) {
            ...
            for(k = 0; k < this.boundingBox.getXSize(); k = k + 4) {
                ...
                FakeMineshaftPieces.Piece mineshaftpieces$piece = FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + k, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ - 1, Direction.NORTH, i);
                if (mineshaftpieces$piece != null) {
            ...
            for(k = 0; k < this.boundingBox.getXSize(); k = k + 4) {
                ...
                FakeMineshaftPieces.Piece mineshaftpieces$piece1 = FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + k, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.maxZ + 1, Direction.SOUTH, i);
            ...
            for(k = 0; k < this.boundingBox.getZSize(); k = k + 4) {
                ...
                FakeMineshaftPieces.Piece mineshaftpieces$piece2 = FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ + k, Direction.WEST, i);
            ...
            for(k = 0; k < this.boundingBox.getZSize(); k = k + 4) {
                ...
                StructurePiece structurepiece = FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ + k, Direction.EAST, i);
    ...
    public static class Stairs extends FakeMineshaftPieces.Piece {
        public Stairs(int p_i50449_1_, MutableBoundingBox p_i50449_2_, Direction p_i50449_3_, FakeMineshaftStructure.Type p_i50449_4_) {
            super(MFStructures.MSSTAIRS, p_i50449_1_, p_i50449_4_);
        ...
        public Stairs(TemplateManager p_i50450_1_, CompoundNBT p_i50450_2_) {
            super(MFStructures.MSSTAIRS, p_i50450_2_);
        }
        ...
        public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand) {
            ...
            if (direction != null) {
                switch(direction) {
                    case NORTH:
                    default:
                        FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, Direction.NORTH, i);
                        break;
                    case SOUTH:
                        FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, Direction.SOUTH, i);
                        break;
                    case WEST:
                        FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, Direction.WEST, i);
                        break;
                    case EAST:
                        FakeMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, Direction.EAST, i);
                }
            }
