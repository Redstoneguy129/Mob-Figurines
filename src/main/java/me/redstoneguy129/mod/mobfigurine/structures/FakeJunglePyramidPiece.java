...
public class FakeJunglePyramidPiece extends ScatteredStructurePiece {
    private boolean placedMainChest;
    private boolean placedHiddenChest;
    private boolean placedTrap1;
    private boolean placedTrap2;
    private static final FakeJunglePyramidPiece.Selector MOSS_STONE_SELECTOR = new FakeJunglePyramidPiece.Selector();

    public FakeJunglePyramidPiece(Random random, int x, int z) {
        super(MFStructures.TEJP, random, x, 64, z, 12, 10, 15);
    }

    public FakeJunglePyramidPiece(TemplateManager p_i51350_1_, CompoundNBT p_i51350_2_) {
        super(MFStructures.TEJP, p_i51350_2_);
    ...
    public boolean create(IWorld worldIn, ChunkGenerator<?> chunkGeneratorIn, Random randomIn, MutableBoundingBox mutableBoundingBoxIn, ChunkPos chunkPosIn) {
        if (!this.isInsideBounds(worldIn, mutableBoundingBoxIn, 0)) {
            ...
            if (!this.placedHiddenChest) {
                ...
                this.generateFigurine(worldIn, mutableBoundingBoxIn, randomIn, 9, -3, 10);
            }
            return true;
        }
    }
